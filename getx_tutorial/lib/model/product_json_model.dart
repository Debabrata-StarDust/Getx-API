...
//
//     final productJson = productJsonFromJson(jsonString);

import 'dart:convert';

List<ProductJson> productJsonFromJson(String str) => List<ProductJson>.from(
    json.decode(str).map((x) => ProductJson.fromJson(x)));

String productJsonToJson(List<ProductJson> data) =>
